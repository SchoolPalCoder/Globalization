...
class TotalTrans extends React.Component {
    ...
    render() {
        return (
            <div>
                <Table rowKey="key" dataSource={this.state.list} columns={this.columns} onChange={src => this.getMore(src)} pagination={{ position: 'top', total: this.state.totalCount }}></Table>
